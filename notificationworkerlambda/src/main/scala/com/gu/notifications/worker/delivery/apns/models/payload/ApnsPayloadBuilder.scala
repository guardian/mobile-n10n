      ...
      customProperties = Seq(
        ...
        CustomProperty(Keys.UsElection2020 ->
          Seq(
            ...
            CustomProperty(Keys.LeftCandidateVoteShare -> n.leftCandidateVoteShare.toString),
            ...
            CustomProperty(Keys.RightCandidateVoteShare -> n.rightCandidateVoteShare.toString),
