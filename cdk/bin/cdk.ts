...
export const dbProxyCodeProps = {
	...
	dbHost: "notifications-registrations-db-private-code.crwidilr2ofx.eu-west-1.rds.amazonaws.com",
...
export const dbProxyProdProps = {
	...
	stage: 'PROD',
	appName: "registrations-db-proxy",
	dbHost: "notifications-registrations-db-private-prod.crwidilr2ofx.eu-west-1.rds.amazonaws.com",
