...
print -r "    "sqsEc2Name: `readStringParameter "android-beta/sqsName"`,
...
print -r "    "sqsEc2Name: `readStringParameter "android-edition/sqsName"`,
...
print -r "    "sqsEc2Name: `readStringParameter "android/sqsName"`,
...
print -r "    "sqsEc2Name: `readStringParameter "ios-edition/sqsName"`,
...
print -r "    "sqsEc2Url: `readStringParameter "ios/sqsUrl"`,
print -r "    "sqsEc2Name: `readStringParameter "ios/sqsName"`,
