...
object Configuration {
  ...
  // class PlatformConfig(config: Config, prefix: String) extends Config {
    
  //   def getString(key: String): String = config.getString(s"prefix/")
  // }

  def fetchConfiguration(workerName: String): Config = {
